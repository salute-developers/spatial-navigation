...
(function () {
    ...
    function focusingController(bestCandidate, dir) {
        ...
        if (bestCandidate) {
            ...
            if (container !== window && getCSSSpatNavAction() === 'focus') {
                bestCandidate.focus();
            } else {
    ...
    function filteredCandidates(currentElm, candidates, dir, container) {
        ...
        if (originalContainer.parentElement && container !== originalContainer && !isVisible(currentElm)) {
            ...
            eventTargetRect =  getBoundingClientRect(currentElm);
        }
    ...
    function findSearchOrigin() {
        ...
        if (!isVisibleInScroller(searchOrigin)) {
            ...
            if (scroller && (scroller === window || getCSSSpatNavAction() === 'auto')) return scroller;
        }
        return searchOrigin;
    }
    ...
    function isVisibleInScroller(element) {
        ...
        if (isInside(scrollerRect, elementRect) && isInside(scrollerRect, elementRect)) return true;
        else return false;
    }
